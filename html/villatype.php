                      ...
                      <div class="row">
                          <div class="col-md-4">
                              ...
                              <div class="card">
                                  ...
                                  <div class="card-body">
                                      <form>
                                        <label class="col-sm col-form-label" for="basic-icon-default-fullname" style="margin-top: 30px;">Villa Type</label>
                                        ...
                                        <label class="col-sm col-form-label" for="basic-icon-default-fullname" style="margin-top: 30px;">Villa Number</label>
                                                <div class="input-group input-group-merge">
                                                  <span id="basic-icon-default-fullname2" class="input-group-text">
                                                    <i class="bx bx-customize"></i>
                                                  </span>
                                          ...
                                          <table class="table" id="myDataTable">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td style="text-align: center;">Standard Villa</td>
