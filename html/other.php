                  ...
                  <div class="card">
                        <div class="card-header">
                            <button type="button" class="btn btn-primary" style="float: right; background-color: #0B6623;">
                              <a href="addother.php" style="text-decoration: none; color: white;">  Add Amenities</a>
                            </button>
                        </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <td style="white-space: nowrap;">
                                        ...
                                        <a href="editother.php"><i class="menu-icon tf-icons bx bx-edit edit_btn"style="color: #3F704D; font-size: 1.3rem;"></i></a>
