                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                             <h3 class="fw-bold">Manage Accommodation Settings</h3>
                          </p>
                    </div>
                      </div>
                      ...
                      <div class="row">
                          <div class="col-md-4">
                              ...
                              <div class="card">
                                  ...
                                  <div class="card-body">
                                      <form>
                                        <label class="col-sm col-form-label" for="basic-icon-default-fullname" style="margin-top: 30px;">Cottage Type</label>
                                                <div class="input-group input-group-merge">
                                                  ...
                                                  <input
                                                    ...
                                                    placeholder="Enter Cottage Type"
                                                    aria-label="Enter your First Name"
                                                    aria-describedby="basic-icon-default-fullname2"
                                                  />
                                                </div>

                                        <label class="col-sm col-form-label" for="basic-icon-default-fullname" style="margin-top: 30px;">Cottage Number</label>
                                                <div class="input-group input-group-merge">
                                                  <span id="basic-icon-default-fullname2" class="input-group-text">
                                                    <i class="bx bx-customize"></i>
                                                  </span>
                                        ...
                                        <button type="button" class="btn btn-primary" style="float: right; background-color: #0B6623; margin-top: 80px;">
                                            Add Cottage
                                        </button>
                                      </form>
                                  </div>
                                          ...
                                          <table class="table" id="myDataTable">
                                              ...
                                              <tbody>
                                                  <tr>
                                                      ...
                                                      <td style="text-align: center;">Small Cottage</td>
                                                      <td style="text-align: center;">
                                                          <a href="#"><i class="menu-icon tf-icons bx bx-show view_btn" style="color: #00308F; font-size: 1.3rem;"></i></a>
                                                          <a href="#"><i class="menu-icon tf-icons bx bx-edit edit_btn"style="color: #3F704D; font-size: 1.3rem;"></i></a>
