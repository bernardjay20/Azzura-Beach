                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                          <form>
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-email">Birthday</label>
                                  <div class="col-sm-4">
                                ...
                                <label class="col-sm-2 col-form-label" for="basic-default-email">Position</label>
                                  <div class="col-sm-4">
                                      <div class="input-group input-group-merge">
                                        <input
                                            type="text"
                            ...
                            <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" for="basic-default-company">User Type</label>
                                    <div class="col-sm-4">
                                      <select class="form-select" id="inputGroupSelect01">
                                        ...
                                        <option value="3">Reservation Specialist</option>
                                      </select>
                                    </div>
                                  <label class="col-sm-2 col-form-label" for="basic-default-company">Unit/Bldng No.</label>
                                    <div class="col-sm-4">
                                        <input
                                        type="text"
                                        class="form-control"
                              ...
                              <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="basic-default-email">Street</label>
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-merge">
                                                <input
                                                    type="text"
                                    ...
                                    <label class="col-sm-2 col-form-label" for="basic-default-email">Barangay</label>
                                      <div class="col-sm-4">
                                          <div class="input-group input-group-merge">
                                          <input
                                              type="text"
                              ...
                              <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="basic-default-email">City</label>
                                            <div class="col-sm-4">
                                                <div class="input-group input-group-merge">
                                                <input
                                                    type="text"
                              ...
                              <div class="row mb-3">
                                    ...
                                    <label class="col-sm-2 col-form-label" for="basic-default-email">Re-Enter Password</label>
                                      <div class="col-sm-4">
                                          <div class="input-group input-group-merge">
                                          <input
                                              type="text"
