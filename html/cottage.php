                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                        <div class="card-header">
                            ...
                            <a href="addcottage.php" style="text-decoration: none; color: white;">  Add Cottages</a>
                            </button>
                        </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <td style="white-space: nowrap;">
                                        ...
                                        <a href="editcottage.php"><i class="menu-icon tf-icons bx bx-edit edit_btn"style="color: #3F704D; font-size: 1.3rem;"></i></a>
