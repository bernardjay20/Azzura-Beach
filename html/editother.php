...
>
  <head>
    ...
    <title>Other Amenities - Azzura</title>
              ...
              <div class="row">
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                             <h3 class="fw-bold">Manage Other Amenities</h3>
                          </p>
                    </div>
                      </div>
                ...
                <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <h5 class="mb-0">Update Amenities</h5>
                        </div>
                        <div class="card-body">
                        <form>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Photo</label>
                                <div class="col-sm-10">
                                <input type="file" class="form-control" id="inputGroupFile02" />
                                </div>
                            </div>
                            <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-company">Amenity Type</label>
                            <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-email">Capacity</label>
                                <div class="col-sm-4">
                                ...
                                <label class="col-sm-2 col-form-label" for="basic-default-email">Free Entrance</label>
                                <div class="col-sm-4">
                                    <div class="input-group input-group-merge">
                                    <input
                                        type="number"
                              ...
                              <div class="col-sm-4" style="margin-top: 6px;">
                                  <div class="input-group input-group-merge">
                                      <div class="form-check form-check-inline">
                                          ...
                                          />
                                          <label class="form-check-label" for="available-status">Available</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                          <input
                                              type="radio"
                                              ...
                                              aria-describedby="status-help-text"
                                          />
                                          <label class="form-check-label" for="unavailable-status">Unavailable</label>
                                      </div>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" for="select-trigger-button">Inclusion</label>
                                  <div class="col-sm-10">
                                      <div class="form-control" id="select-trigger-button" onclick="toggleOptions()">Select an option</div>
                                      <select id="hidden-select" class="form-select" aria-describedby="basic-icon-default-message2" multiple>
...
<script>
  ...
  function toggleOptions() {
    var selectElement = document.getElementById("hidden-select");
