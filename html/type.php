                          ...
                          <div class="col-md-4">
                              ...
                              <div class="card">
                                  <div class="card-header">
                                      <h5>Add Hotel Room</h5>
                                  </div>
                                  <div class="card-body">
                                      <form>
                                        <label class="col-sm col-form-label" for="basic-icon-default-fullname" style="margin-top: 30px;">Room Type</label>
                                        ...
                                        <label class="col-sm col-form-label" for="basic-icon-default-fullname" style="margin-top: 30px;">Room Number</label>
                                                <div class="input-group input-group-merge">
                                                  <span id="basic-icon-default-fullname2" class="input-group-text">
                                                    <i class="bx bx-customize"></i>
                                                  </span>
