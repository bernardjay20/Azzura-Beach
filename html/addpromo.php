              ...
              <div class="row">
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                             <h3 class="fw-bold">Manage Discounts &amp; Promos</h3>
                          </p>
                    </div>
                      </div>
                ...
                <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <h5 class="mb-0">Add Promo</h5>
                        </div>
                        <div class="card-body">
                        <form>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Promo Code</label>
                                <div class="col-sm-10">
                                    <input
                                    type="text"
                                    class="form-control"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Promo Name</label>
                                <div class="col-sm-10">
                                    <input
                                    type="text"
                                    class="form-control"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Minimum Amount</label>
                                    <div class="col-sm-10">
                                        <input
                                        type="number"
                                        class="form-control"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Discount Value</label>
                                <div class="col-sm-10">
                                    <input
                                    type="number"
                                    class="form-control"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-email">Start Date</label>
                                <div class="col-sm-10">
