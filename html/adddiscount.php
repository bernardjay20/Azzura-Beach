              ...
              <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <form>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Discount Name</label>
                                <div class="col-sm-10">
                                    <input
                                    type="text"
                                    class="form-control"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-company">Discount Type</label>
                                    <div class="col-sm-10">
